...
namespace NextErp.Infrastructure.Migrations
{
    ...
    [Migration("20260711180350_AddRefreshTokenRotation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NextErp.Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex("TenantId", "BranchId", "UserId", "ReadAt");

                    b.ToTable("Notifications", (string)null);
                });

            modelBuilder.Entity("NextErp.Domain.Entities.OnlineOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NextErp.Domain.Entities.OnlineOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NextErp.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NextErp.Domain.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NextErp.Domain.Entities.SystemSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CustomPrimary")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("CustomSecondary")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("CustomSidebarBackground")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("CustomSidebarForeground")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<string>("NavigationPlacement")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
                        .HasColumnType("nvarchar(16)")
            ...
            modelBuilder.Entity("NextErp.Domain.Entities.UnitOfMeasure", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NextErp.Domain.Entities.OnlineOrderItem", b =>
                {
                    b.HasOne("NextErp.Domain.Entities.OnlineOrder", "OnlineOrder")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("NextErp.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("NextErp.Domain.Entities.UnitOfMeasure", "UnitOfMeasure")
                        .WithMany()
                    ...
                    b.OwnsOne("NextErp.Domain.Entities.PromotionConfig", "Config", b1 =>
                        {
                            ...
                            b1.Property<string>("BuyCategoryIds")
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("BuyProductIds")
                                .HasColumnType("nvarchar(max)");
                            ...
                            b1.Property<string>("GetProductIds")
                                .HasColumnType("nvarchar(max)");
                            ...
                            b1.Property<decimal?>("MaxRewardQuantity")
                                .HasColumnType("decimal(18,2)");
